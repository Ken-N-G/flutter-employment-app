...
class EditVisionAndMissionSection extends StatefulWidget {
  const EditVisionAndMissionSection({super.key});

  @override
  State<EditVisionAndMissionSection> createState() => _EditVisionAndMissionSectionState();
}

class _EditVisionAndMissionSectionState extends State<EditVisionAndMissionSection> with WidgetsBindingObserver {

  late bool _hideSaveButton;
  late TextEditingController visionAndMissionController;
  ...
  void initState() {
    ...
    visionAndMissionController = TextEditingController();
    WidgetsBinding.instance.addObserver(this);
    Future.microtask(() {
      var profileProvider = Provider.of<ProfileProvider>(context, listen: false);
      visionAndMissionController.text = profileProvider.userProfile!.visionMission;
    });
  }
  ...
  void dispose() {
    super.dispose();
    visionAndMissionController.dispose();
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CustomTextFormField(
                            ...
                            controller: visionAndMissionController,
                            validator: (input) => profileProvider.validateVisionAndMission(input),
                          ),
                        ...
                        onTap: () async {
                          if (formKey.currentState!.validate()) {
                            ...
                            bool successfulUpload = await profileProvider.setUserProfile(
                              visionMission: visionAndMissionController.text.trim()
                            );
